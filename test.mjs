...
for (let i = 0; i < 10; i++) {
  await renderToStringNode(/* @__PURE__ */ jsx(App, {}));
  await renderToStringWeb(/* @__PURE__ */ jsx(App, {}));
}
console.time("node");
const r1 = await renderToStringNode(/* @__PURE__ */ jsx(App, {}));
console.timeEnd("node");
console.time("web");
const r2 = await renderToStringWeb(/* @__PURE__ */ jsx(App, {}));
console.timeEnd("web");
